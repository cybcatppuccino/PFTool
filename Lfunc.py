...
if __name__ == '__main__':
    ...
    for _ in range(5):
        print("-")
    # Important! This case is the Re and Im part of (1/3,1/3,2/3,2/3) attractor. 
    print(testL41_normal(2.883041905048269916))
    print(testL41_normal(1.040968863364843232))
    '''
